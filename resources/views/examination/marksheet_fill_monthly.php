...
<script type="text/javascript">
      function for_list(){ 
			...
			if(student_class_section!='' && student_class!='' && exam_type!='' && subject_name!='' ){
             ...
             $.ajax({
			  type: "POST",
             url:  access_link+"examination/ajax_fill_marksheet_monthly.php?id="+student_class+"&student_section="+student_class_section+"&subject_name="+subject_name+"&student_exam_type="+exam_type+"&student_class_stream="+student_class_stream+"&student_class_group="+student_class_group+"&order_by="+order_by+"",
              cache: false,
		...
		<div class="col-md-3" id="student_class_group_div" style="display:none;">				
			  ...
			  <div class="form-group" >
                ...
                <tr>
				  ...
				  <th>Update By</th>
                  <th>Date</th>
                  <th><input type="checkbox" value="" id="sms_checked" onclick="for_check(this.id);" /><b style="color:red;"> SMS All</b></th>
